...
MODULE_DESCRIPTION("kernel_timer for high resolution");

#define SELF_DEV_NAME "my_hr_timer_driver"
...
// hrtimer supports nano-second degree
...
static enum hrtimer_restart test_hrtimer_handler(struct hrtimer *timer) {
  /* get current time */
  u64 now_time = jiffies; // get time by system tick
